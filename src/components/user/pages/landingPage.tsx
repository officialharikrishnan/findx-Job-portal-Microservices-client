        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="container max-w-lg px-4 py-32 mx-auto text-left md:max-w-none md:text-center">
            <h1 className="text-5xl font-extrabold leading-10 tracking-tight text-left text-gray-900 md:text-center sm:leading-none md:text-6xl lg:text-7xl">
              <span className="inline md:block">Get The Right Job</span>
              <span className="relative mt-2 text-transparent bg-clip-text bg-gradient-to-br from-sky-600 to-sky-500 md:inline-block">
                You Deserve
              </span>
            </h1>
            ...
            <div className="w-full sm:w-1/2 p-6 mt-6">
              ...
              >
                ...
                <path
                  ...
                  stroke-width="2"
                />
                <circle cx="214.07" cy="310.65" r="11.968" fill="#bae6fd" />
                <circle cx="322.2" cy="566.52" r="11.968" fill="#bae6fd" />
                <circle cx="780.7" cy="309" r="11.968" fill="#bae6fd" />
                <circle cx="991.17" cy="607.78" r="11.968" fill="#bae6fd" />
                <circle cx="600.35" cy="480.68" r="11.968" fill="#bae6fd" />
              </svg>
            </div>
            <div className="w-full sm:w-1/2 p-6 mt-6">
